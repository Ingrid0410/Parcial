<?php
    ...
    function save_data_supabase($email, $passwd){
        $SUPABASE_URL = 'https://rpflobxobqgeocmknzvi.supabase.co';
        $SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJwZmxvYnhvYnFnZW9jbWtuenZpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzMyMTM5OTEsImV4cCI6MjA0ODc4OTk5MX0.LUJKgCnSpq3amZ2xcAcrOFi7zPCcphku16i5qgVVLWU'; 
